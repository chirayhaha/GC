<template>
    <div class="orderdetail">
        ...
        <div class="middle" v-for="(order,index) in orderinfo" :key="index">
            <span class="sid">{{order.storeid}}</span>
            <span class="add">address:{{order.address}}</span>
            <span class="phone"> conphone:{{order.conphone}}</span>
            <span class="name"> foodname:{{order.foodname}} </span>
            <span class="orderid">orderid:{{order.orderid}} </span>
            <span class="num"> ordernum: {{order.ordernum}}</span>
