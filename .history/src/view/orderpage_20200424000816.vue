  ...
  <div class="orderpage">
    ...
    <div class="middle">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="失效" name="all">
          <div v-for="(all, no) in allinfo" :key="no" class="payinginfo">
            <div @click="getsellerinfo(all.storeid)">{{all.storeid}}<i class="el-icon-arrow-righ"></i></div>
            <div class="list">
              <img />
              <div class="goodinfo">
                <div class="n">
                  <span class="name">{{all.foodname}}</span>
                  <span class="num">x{{all.ordernum}}</span>
                </div>

                <div class="total">
                  <span>实付：￥{{all.total}}</span>
                  <p>订单编号：{{all.orderid}}</p>
                </div>
              </div>
            </div>
              <button class="topay" @click="topay">支付</button>
