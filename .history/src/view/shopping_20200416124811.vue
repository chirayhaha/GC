  ...
  <div class="shopping">
    ...
    <div class="gwc" v-for="(cart,index) in carinfo" :key="index">
      ...
      <div class="info">
        ...
        <div class="name">
          {{cart.good.goodname}}<!-- {{goods.goodname}} -->
          <div class="num">
            <el-input-number v-model="cart.goodnum" size="mini" @change="addcginfo(cart.good.id,cart.goodnum)" :min="1"></el-input-number>
          </div>
        </div>
        <div class="price">
          <div>￥{{cart.good.goodprice}}<!-- {{goods.goodprice}} --></div>
