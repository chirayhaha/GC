<template>
  <div class="address">
    <div class="top">
      <back class="back" @click="show"></back>
...
import alladdress from '../components/address';
...
export default {
  ...
  methods: {
    ...
    setaddress(add,index){/* 
      let address = setLocalStorage('address',add)
        this.$router.push({name:'orderconfirm',params:{id:index}}) */
    },
    show(){
      this.show = false
    }
