...
export default {
    ...
    return {
      mylist: [
        ...
        },
        {
          ...
          this_all: true,
          newlist: [
            { newname: "西瓜", check_one: true, price: 35 },
            { newname: "桃子", check_one: true, price: 20 }
          ]
        },
        {
          oname: "第三个",
  ...
  methods: {
    ...
    click_input: function(i, j) {
      ...
      checklist.length == this.mylist[i].newlist.length
        ? (this.mylist[i].this_all = true)
        : (this.mylist[i].this_all = false);
      this.abc();
    },
    btn: function() {
