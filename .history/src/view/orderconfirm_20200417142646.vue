...
export default {
  ...
  data() {
    return {
      ...
      paying: false,
      storeid: "",
      payinfo:{userid:'',foodname:'',ordernum:0,address:'',storeid:'',total:0,conphone:0}
    };
  },
  components: { back },
  filters: {
      ...
      for (let i = 0; i < this.goodslist.length; i++) {
        ...
        console.log(
          address +
            ...
            this.storeid+JSON.stringify(total)
        );
        ...
        payinfo.storeid = this.storeid
        payinfo.total = total
        payinfo.conphone =  conphone
        console.log(JSON.stringify(payinfo)+storeid)
