  ...
  <div class="shopping">
    ...
    <div class="gwc">
      ...
      <el-checkbox-group v-model="checkedArr">
        <el-checkbox v-for="(cart,index) in carinfo" :key="index" :label="cart">
          <!-- <img style="width:80px;height:80px;"> -->
          <div class="info">
            <span class="name">{{cart.good.goodname}}</span>
            <span class="price">{{cart.good.goodprice}}</span>
            <div class="num">
              <el-input-number v-model="cart.goodnum" size="mini"
                @change="addcginfo(cart.good.id,cart.goodnum)" :min="1"></el-input-number>
            </div>
            <span class="num">{{cart.goodnum}}</span>
          </div>
