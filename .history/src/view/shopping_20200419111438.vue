<template>
  <div class="shopping">
    ...
    <div class="gwc" v-for="(cart,index) in carinfo" :key="index">
      <el-checkbox-group v-model="carinfo">
        <el-checkbox label="cart.good.goodname">
          <img />
          <div class="info">
            <!-- <div>
              <el-checkbox class="checkbox" v-model="cart.selected" @click="selected(cart.good.id)"></el-checkbox>
            </div> -->
            <div>
              <img class="img" :src="goodslist.imgurl" />
            </div>
            <div class="name" v-for="(good,id) in cart.good" :key="id">
              {{good.goodname}}
              <!-- {{goods.goodname}} -->
              <div class="num">
                <el-input-number
