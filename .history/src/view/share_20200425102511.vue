<template>
  <div class="share">
    ...
    <el-form :model="uploadForm" :rules="rules" ref="uploadForm" hide-required-asterisk label-width="70px" 
    class="uploadForm" size="small">
      ...
      <el-form-item label="食材" prop="context" class="context">
        ...
        <el-tag v-for="tag in uploadForm.tags" :key="tag.name" closable @close="handleClose(tag)">{{tag}}</el-tag>
