...
export default{
    ...
    allunselected:baseUrl+'/users/allunselected',
    unselected:baseUrl+'/users/unselected',
    getorder:baseUrl+'/users/getorder',
    getaddress:baseUrl+'/users/getaddress',
    delcart:baseUrl+'/users/delcart',
    createbill:baseUrl+'/users/createbill',
    paybill:baseUrl+'/users/paybill',
    getpayed:baseUrl+'/users/getpayed',
    getpaying:baseUrl+'/users/getpaying',
    gettaken:baseUrl+'/seller/gettaken',
    gettaking:baseUrl+'/seller/gettaking',
    cancelorder:baseUrl+'/users/cancelorder',
    takeorder:baseUrl+'/seller/takeorder',
    gettakenorder:baseUrl+'/users/gettakenorder',
    getsellerinfo:baseUrl+'/users/getsellerinfo',
    getallgoods:baseUrl+'/users/getallgoods',
    searchbook:baseUrl+'/users/searchbook',
    getallorders:baseUrl+'/users/getallorders',
    getCancelorders:baseUrl+'/users/getCancelorders',
    orderdetail:baseUrl+'/users/orderdetail',
    getCancel:baseUrl+'/seller/getCancel'
}